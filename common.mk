...
NVCXX_MFLAGS = --m64
NVCXX_WFLAGS = --Werror cross-execution-space-call,reorder,default-stream-launch,missing-launch-bounds,ext-lambda-captures-this -Xptxas -v
...
NVCXX_DFLAGS = -DSCALAR_PRECISION_32 -DLABEL_SIZE_32
